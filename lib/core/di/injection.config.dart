...
import '../../screen/operations_sync/bloc/bloc.dart' as _i21;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i21.OperationSyncBloc, List<_i20.Operation>?, dynamic>(
      (operations, _) =>
          _i21.OperationSyncBloc(operations, get<_i13.OperationsRepository>()));
  gh.factoryParam<_i22.OperationUpdateBloc, _i20.Operation?, dynamic>(
      (operation, _) => _i22.OperationUpdateBloc(
          operation, get<_i13.OperationsRepository>()));
  gh.singleton<_i23.RegistrationBloc>(
      _i23.RegistrationBloc(get<_i7.AuthRepository>(), get<_i16.AuthBloc>()));
  return get;
}
